...
//const repos = new Subg('.', true, 'tmp/repos.yml', '.');
//const repos = new Subg('.', true, 'tests/test_repos_1.yml', 'tmp3');
const repos = new Subg('.', true, 'tests/test_repos_2.yml', 'tmp3');

//await repos.discover_repos();
//await repos.discover_repos('..');
//await repos.import_yaml('tests/test_repos_1.yml', 'tmp3');
await repos.init();
//await repos.init('..');
